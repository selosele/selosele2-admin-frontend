...
const navItems = [
  { to: '/system/code',         name: '공통코드 관리' },
  { to: '/system/menu',         name: '메뉴 관리' },
  { to: '/system/category',     name: '카테고리/태그 관리' },
  { to: '/system/post-reply',   name: '포스트 댓글 관리' },
  { to: '/system/content',      name: '콘텐츠 관리' },
  { to: '/system/satisfaction', name: '만족도조사 관리' },
  { to: '/system/search',       name: '검색 관리' },
  // { to: '/system/program', name: '프로그램 관리' }
]
